...
public partial class MigDatabaseContext : DbContext
{
    ...
    public virtual DbSet<Entities.Monitor> Monitors { get; set; }
    ...
    public virtual DbSet<Entities.Switch> Switches { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Entities.Monitor>(entity =>
        {
        ...
        modelBuilder.Entity<Entities.Switch>(entity =>
        {
