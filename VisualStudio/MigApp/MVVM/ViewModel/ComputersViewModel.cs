...
namespace MigApp.MVVM.ViewModel
{
    internal class ComputersViewModel : Core.ViewModel
    {
        ...
        public async Task LoadTableAsync()
        {
            try
            {
                DataTable temp = await pgsql.GetTable("id, inventory_number, name, fio, room, ip, operating_system, motherboard, processor, ram, drive, other, comment", "\"Technic\".computers_view", Filter);
                ...
                temp.Columns["motherboard"].ColumnName = "Материнская плата";
