...
{
    internal class LaptopsViewModel : Core.ViewModel
    {
        ...
        public async Task LoadTableAsync()
        {
            //try
            //{
            //    DataTable temp = await pgsql.GetTable("id, inventory_number, model, fio, room, serial_number, diagonal, resolution, operating_system, processor, ram, drive, other, comment", "\"Technic\".laptops_view", Filter);
            //    if (temp != null)
            //    {
            ...
            //        Table = temp;
            //    }
            //    else Debug.WriteLine("LaptopsView: Получена пустая таблица из базы данных");
            //}
            //catch
            //{
